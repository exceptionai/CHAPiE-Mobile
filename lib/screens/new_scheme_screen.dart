...
class NewSchemeScreen extends StatefulWidget {
  @override
  _NewSchemeScreenState createState() => _NewSchemeScreenState();
}

class _NewSchemeScreenState extends State<NewSchemeScreen> {
